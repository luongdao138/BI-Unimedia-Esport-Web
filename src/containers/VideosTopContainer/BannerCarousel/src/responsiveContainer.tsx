...
export interface ResponsiveContainerProps {
  render: (parentWidth: number, carouselRef?: React.RefObject<StackedCarousel>) => React.ReactNode
...
export default function ResponsiveContainer(props: ResponsiveContainerProps) {
  ...
  return (
    <div ref={ref as React.RefObject<HTMLDivElement>} className="stacked-carousel-responsive-container" style={{ width: '100%' }}>
