...
const ChatContainer: React.FC<ChatContainerProps> = forwardRef(
  (
    ...
    const { userResult, streamingSecond, liveStreamInfo, resetState } = useDetailVideo()
    // const { streamingSecond, videoPlayedSecond.current, isViewingStream, liveStreamInfo } = useDetailVideo()
