...
interface StepTwoMissingPointsProps {
  step: number
...
const StepTwoMissingPoints: React.FC<StepTwoMissingPointsProps> = ({ step, cards, deleteCard, onNext, missingPoints }) => {
      ...
      <form onSubmit={formik.handleSubmit}>
        <Box className={classes.container}>
          <Box className={classes.wrap_point}>
            <Typography className={classes.point}>{missingPoints}</Typography>
...
export default StepTwoMissingPoints
