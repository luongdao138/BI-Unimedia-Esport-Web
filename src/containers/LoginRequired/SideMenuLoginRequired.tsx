...
const SideMenuLoginRequired: React.FC = ({ children }) => {
        ...
        if (React.isValidElement(child)) {
          if (child.props.href) {
            return React.cloneElement(child, {
              ...
              as: isAuthenticated ? child.props.href.pathname ?? child.props.href : ESRoutes.LOGIN,
            })
          }
...
export default SideMenuLoginRequired
