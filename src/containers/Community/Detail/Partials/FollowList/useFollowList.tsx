...
import { CommunityMember, CommunityMembersApproveCancelParams, CommunityMembersParams } from '@services/community.service'
...
const useFollowList = (): {
  ...
  const cancelMembers = (params) => dispatch(actions.approveCommunityMembers(params))
