import { makeStyles, IconButton, Avatar, SvgIcon } from '@material-ui/core'
...
const TwitterPopUpShareButton: React.FC<SocialProps> = ({ url, className, title = '', height = 600, width = 600 }) => {
  ...
  const handleOnClick = () => {
    window.open(
      ...
      '',
      `menubar=no, toolbar=no, resizable=yes, scrollbars=yes, height=${height}, width=${width}, top=50px`
    )
  }

  return (
    <IconButton href="" onClick={handleOnClick} target="_blank" classes={{ root: classes.iconRoot }} className={className}>
...
export default TwitterPopUpShareButton
