  ...
  return (
    <Box pt={8} className={classes.container}>
      <ESTabs value={tab} onChange={(_, v) => onTabChange(v)} className={classes.tabs}>
        <ESTab className={classes.tabMin} label={i18n.t('common:lobby_create.tab1')} value={0} />
        <ESTab className={classes.tabMin} label={i18n.t('common:lobby_create.tab2')} value={1} />
      </ESTabs>
    </Box>
  )
}
