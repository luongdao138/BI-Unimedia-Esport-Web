...
とくにオンラインで開催する際は、何のツールを使うのか、明記することをおすすめいたします。`,
  ...
  streaming_gift_report_screen: {
    ...
    kinds: '種別',
    tip_target: 'チップ対象',
    is_total_amount_of_chips_received: 'は受け取ったチップの総額です。',
    csv: 'CSV',
  ...
  streaming_gift_management: {
    ...
    empty_message_md: '個別ギフト対象の追加をご希望の場合、\n下記より追加申請のご対応をお願いします。',
    add: '追加',
    edit: '編集',
    delete: '削除',
    ...
    delete_dialog_title: '個別ギフトリストを削除します',
    delete_dialog_deleted_name: 'リスト名',
    delete_dialog_warning_1: '削除した個別ギフトリストを復元させることはできません。',
