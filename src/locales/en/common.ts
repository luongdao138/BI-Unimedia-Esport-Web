export default {
  ...
  confirm_member: {
    ...
    from: '人',
    confirm_title: '選択したメンバーで確定しますか？',
    confirm_cancel_title: 'いいえ',
    confirm_ok_title: '確定する',
    confirm_warning_title: '確定後はメンバーの変更はできません',
    shuffle_title: 'ユーザーをランダムに選びますか？',
    shuffle_description: '現在エントリーしているユーザーから参加者をランダムに選ぶことができます。',
    shuffle_cancel_title: 'キャンセル',
    shuffle_ok_title: 'ランダムに選ぶ',
    shuffle_warning_title: 'この時点ではまだ参加者は確定しません',
  },
  page404: {
    title: '404',
...
楽しく練習しましょう〜の会です。`,
  ...
  lobby: {
    ...
    entry_confirmation_dialog: {
      ...
      cancelationText: 'キャンセル',
    },
    decline_entry_dialog: {
      title: 'エントリーを辞退しますか？',
      desc: '再度エントリーすることができます。',
      warningText: '',
    ...
    confirm_member_dialog: {
      ...
      desc: '現在エントリーしているユーザーから参加者をランダムに選ぶことができます。',
      warningText: 'この時点ではまだ参加者は確定しません',
