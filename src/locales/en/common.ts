...
また、上記で「その他」を選んだ方はその内容をご記入ください。`,
  ...
  tournament: {
    ...
    close_recruitment: {
      ...
      dialog_description_br: '手動でエントリー締切を実施しない場合は、エントリー期間終了後に自動でエントリーが締め切られます。',
      confirm: '締め切る',
    ...
    participants: '参加{{isTeam, member_type}}',
    group_chat: 'グループチャット',
    brackets: '対戦表',
    select_br_participants: '参加{{isTeam, member_type}}選択',
...
とくにオンラインで開催する際は、何のツールを使うのか、明記することをおすすめいたします。`,
  ...
  streaming_setting_screen: {
    ...
    validation: {
      ...
      start_time_at_least_30min: '配信開始予定日時は、30分以上空けた日時を入力してください',
    },
    shared_it: '共有する',
    dont_share: '共有しない',
    ...
    individual_gift_list: '個別ギフトリスト',
    individual_gift_tab: {
      create_new: 'チップ対象リストを作成する',
      number_of_registration: '登録数',
      list_name: 'リスト名',
      edit: '編集',
      remove: '削除',
    },
    ...
    dialog_info_gift_list: {
      ...
      content: {
        ...
        row4: '個別に送られたチップは一時的に配信者に送られますので、[配信レポート]→[チップレポート]を参照して対象者へ振り分けてください。',
      },
    },
    dialog_info_ranking: {
      title: 'ランキング表示',
  ...
  purchase_point_tab: {
    ...
    note_purchase_point: '※eXeポイントの購入はキャンセル・返金が出来ません。予めご了承下さい。',
    ...
    mess_exceed_card: '登録できる枚数は最大5枚です',
    btn_understand_error: '了解',
    validation: {
  ...
  videos_top_tab: {
    ...
    resolution_select: '画質選択',
    auto: '自動',
    report_setting: '再生に関する問題を報告',
    report_reason_interrupt: '音声と映像が途切れる',
    report_reason_delayed: '音声と映像がずれている',
    report_reason_video_can_not_load: 'ビデオが読み込まれない',
    report_reason_video_can_not_play: 'フルスクリーン再生ができない',
    send: '送信',
  ...
  live_stream_screen: {
    ...
    buy_ticket: 'チケット購入',
    purchase_ticket_note: '本配信は有料チケットを購入されたユーザーのみ閲覧が可能です',
    chat_purchase_ticket_note: '視聴チケットを所有していないユーザーは本配信でのチャット機能はご利用頂けません。',
    delivery_start_date_and_time: '配信開始日時',
    ...
    please_select_member: 'チップ送付先を1つ選んでください。',
    streamer_title: '配信者',
    receiver_title: '出演者',
    team_receiver_type: '個人',
    text_select_member: '選択',
    place_holder_tip: 'コメントを入力してください。',
    tooltip_tip:
      'チップのご紹介：\nチップは、番組配信者やお気に入りの出演者を応援できる新しい方法です。\nチップリストから配信者、またはチームや出演者を選択してeXeポイント付きのメッセージを贈ることができます。\nチップで贈ったメッセージは他のメッセージよりも目立たせることができるほか、贈ったeXeポイントに応じてチャット上部のピックアップ部分に長く自分のチップを表示することができます。また、チップを贈ることランキングにも参加できるので積極的にチップを贈ってみましょう！',
  ...
  donate_points: {
    ...
    title_send_message: 'ここに送りたいテキストメッセージが入ります。',
  ...
  streaming_gift_report_screen: {
    ...
    create_tip_target_list: 'チップ対象リストを作成する',
    select_tip_target_list: '設定するチップ対象リストを選択してください',
    tip_target_list_selection: 'チップ対象リスト選択',
    tip_target_person: 'チップ対象者',
    number_of_chips: 'チップ回数',
    total_chips: '合計チップ',
    buyer: '購入者',
    payment_points: '支払いポイント',
    eXeLAB_ID: 'eXeLAB ID',
    kinds: '種別',
    tip_target: 'チップ対象',
    is_total_amount_of_chips_received: '合計チップは受け取ったチップの総額です。',
    csv: 'CSV',
  ...
  streaming_gift_management: {
    ...
    apply: 'この内容で申請する',
    cancel: 'キャンセル',
    empty_message: 'チップ対象者の追加をご希望の場合、下記より追加申請をお願いします。',
    empty_message_md: 'チップ対象者の追加をご希望の場合、\n下記より追加申請をお願いします。',
    add_master_message: 'チップ対象者の追加をご希望の場合、下記より追加申請のご対応をお願いします。',
    add_master_message_md: 'チップ対象者の追加をご希望の場合、\n下記より追加申請のご対応をお願いします。',
    add: '追加',
    edit: '編集',
    delete: '削除',
    team_or_individual: 'チームもしくは個人',
    team_or_individual_sm: 'チームor個人',
    target_name: '対象者名',
    target_name_sm: '対象者',
    sns_url: 'SNS URL',
    sns_url_sm: 'URL',
    ...
    delete_confirm: '削除する',
    delete_cancel: 'キャンセル',
    message_gift_success: `eXeLAB運営にて確認の上、申請結果を配信者登録時に設定いただいたメールアドレスへ \nご連絡いたしますので、返信をお待ちください。`,
    message_gift_success_sp: `eXeLAB運営にて確認の上、申請結果を配信者登録時に \n設定いただいたメールアドレスへご連絡いたしますので、\n返信をお待ちください。`,
  ...
  archive_detail_screen: {
    ...
    delete_dialog_title: 'アーカイブ動画を削除',
    delete_dialog_sub_title: '一度削除した動画を復元することはできません。\n' + '本当に削除してよろしいですか？',
    cancel: '戻る',
    delete_confirm: '削除する',
    update: '更新',
    delete_warning:
      '動画のダウンロードを実施中の場合、削除を実施するとファイルが正常に取得できない場合がございます。\n動画の削除はファイルのダウンロードが完了した後に実施いただけますようお願いいたします。',
    report_data: '配信レポートを見る',
  },
}
