...
また、上記で「その他」を選んだ方はその内容をご記入ください。`,
  ...
  tournament: {
    ...
    close_recruitment: {
      ...
      dialog_description_br: 'エントリー人数と参加枠数の設定に差がある場合、自動的に参加枠数の最適化を行います。',
      confirm: '締め切る',
    ...
    participants: '参加メンバー',
    br_participants: '参加{{isTeam, participation_type}}',
    group_chat: 'グループチャット',
    brackets: '対戦表',
    select_br_participants: '参加{{isTeam, participation_type}}選択',
